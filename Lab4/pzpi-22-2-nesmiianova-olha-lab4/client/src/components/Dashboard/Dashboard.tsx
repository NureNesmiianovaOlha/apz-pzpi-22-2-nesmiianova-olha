...
import IoTDeviceList from '../iot/IoTDeviceList';
import StudentActivityMonitor from '../iot/StudentActivityMonitor';
  ...
  const renderTeacherDashboard = () => (
    <div className={styles.dashboardSection}>
      ...
      <div className={styles.buttonGrid}>
        ...
        <button 
          className={`${styles.dashboardButton} ${activeComponent === 'iot-monitor' ? styles.active : ''}`}
          onClick={() => setActiveComponent('iot-monitor')}
        >
          IoT Моніторинг студентів
        </button>
      </div>
      ...
      <div className={styles.componentContainer}>
        {loading ? (
          ...
          <>
            ...
            {activeComponent === 'iot-monitor' && <StudentActivityMonitor />}
          </>
        )}
      </div>
    </div>
  ...
  const renderAdminDashboard = () => (
    <div className={styles.dashboardSection}>
      ...
      <div className={styles.buttonGrid}>
        ...
        <button 
          className={`${styles.dashboardButton} ${activeComponent === 'iot-devices' ? styles.active : ''}`}
          onClick={() => setActiveComponent('iot-devices')}
        >
          IoT Пристрої
        </button>
        <button 
      ...
      <div className={styles.componentContainer}>
        ...
        {activeComponent === 'iot-devices' && <IoTDeviceList />}
        {activeComponent === 'iot-monitor' && <StudentActivityMonitor />}
      </div>
    </div>
  );
